...
namespace GK
{
    public class QLBHADO
    {
        ...
        {
            string sql = @"select count (*) from BANHANG where MAMH=@mamh";
            SqlConnection con = new SqlConnection(connectString);
            SqlCommand cmd = new SqlCommand(sql, con);
        ...
        public DateTime checkNgayTra(string mamh)
        {
            string sql = @"select NGAYTRA from BANHANG where MAMH=@mmh";
            SqlConnection con = new SqlConnection(connectString);
            SqlCommand cmd = new SqlCommand(sql, con);
            cmd.Parameters.AddWithValue("@mmh", mamh);
            con.Open();
            ...
            count = Convert.ToDateTime(read["NGAYTRA"].ToString());
            con.Close();
            return count;
        }
